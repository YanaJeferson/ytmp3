...
const Footer = () => {
  return (
    <>
      <div className="flex shadow-xl border boder-gray" style={{boxShadow:"0px -3px 15px -3px", color:"#c7c7c7"}}>
        <Container className="text-center flex-row " >
          <Container className="flex justify-center gap-6 pt-3">
            <svg
          ...
          <Container>
            <p className="py-3 text-gray-600">
              &copy; 2019 All rights reserved by the author.
            </p>
          </Container>

          <Container className="flex justify-center pb-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
